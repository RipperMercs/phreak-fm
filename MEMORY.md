...
**What's built:**
- 230+ static pages across three verticals plus the DOS Virus Museum
- Homepage: MOTD, system status bar, scrolling headline ticker, two-column layout (articles left, live feeds right)
- Signals vertical with 18 original phreaker elder stubs now filled in with full bodies, plus 13 new longform pieces (Morris Worm, CCC, Phrack, Operation Sundevil, Hacker Manifesto, 414s, DEF CON history, Phiber Optik, Shimomura, Dark Avenger, Alvi Brothers/Brain, demoscene as hacking, 2600Hz welcome post)
- Frequencies vertical with Pirate Signal outsider music showcase, plus 12 new long-form features (Warp Records at 35, Hyperdub label profile, Burial, Boards of Canada, Jon Hopkins, Four Tet, Autechre, ambient history, cassette revival, Ghost Box hauntology, modular synth scene, demoscene music) and 3 new Pirate Signal drops (Circuit Psalms, Dead Mall Frequencies, Shortwave Hymns)
- Static vertical with 10 new essays (BBS era, text files, Wayback Machine, RSS is not dead, ANSI art underground, GeoCities archaeology, IRC channels, personal websites comeback, demoscene, death of the forum)
- DOS Virus Museum expanded: 25 launch specimens now backed by real writeups plus 10 new specimens (Creeper, Elk Cloner, Concept, Melissa, ILOVEYOU, Dark Avenger, Frodo, Whale, Hymn, Barrotes) covering pre-DOS and post-DOS eras
...
- Real museum visual assets (hero images still placeholder PNGs)
...
- **April 14, 2026:** Massive content drop (commit efbd334, 100 files, 5,406 insertions). Filled in bodies for all 18 original Signals phreaker stubs and all 25 launch museum specimens. Shipped 13 new Signals longform pieces, 12 new Frequencies features, 10 new Static essays, 3 new Pirate Signal drops, and 10 new museum specimens extending the archive into pre-DOS (Creeper, Elk Cloner) and macro/worm era (Concept, Melissa, ILOVEYOU). Site now has 230+ static pages. Hero images still placeholder, visual asset capture work still pending.
