...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/ephemera`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.6 },
    ...
    { url: `${baseUrl}/relay`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.6 },
    { url: `${baseUrl}/lexicon`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.6 },
