...
export const feedSources: FeedSource[] = [
  ...
  },
  {
    name: "CISA KEV",
    slug: "cisa-kev",
    url: "https://www.cisa.gov/feeds/known-exploited-vulnerabilities.json",
    vertical: "signals",
    trustTier: 1,
  },
  {
  ...
  {
    name: "404 Media Security",
    slug: "404-media-security",
    url: "https://www.404media.co/tag/security/rss/",
    vertical: "signals",
    trustTier: 1,
  },
  {
  ...
  },
  {
    name: "Boomkat",
    slug: "boomkat",
    url: "https://boomkat.com/feed",
    vertical: "frequencies",
    trustTier: 1,
  },
  {
    name: "Pitchfork Electronic",
    slug: "pitchfork-electronic",
    url: "https://pitchfork.com/feed/feed-electronic/rss",
    vertical: "frequencies",
    trustTier: 1,
  },
  {
  ...
  },
  {
    name: "Fluid Radio",
    slug: "fluid-radio",
    url: "https://www.fluid-radio.co.uk/feed/",
    vertical: "frequencies",
    trustTier: 2,
  },
  {
    name: "A Closer Listen",
    slug: "a-closer-listen",
  ...
  },
  {
    name: "15 Questions",
    slug: "15-questions",
    url: "https://15questions.net/feed/",
    vertical: "frequencies",
    trustTier: 2,
  },
  {
...
export function getFeedsByVertical(
  vertical: "signals" | "frequencies" | "static"
): FeedSource[] {
  return feedSources.filter((f) => f.vertical === vertical);
}

export function getFeedBySlug(slug: string): FeedSource | undefined {
  return feedSources.find((f) => f.slug === slug);
}
