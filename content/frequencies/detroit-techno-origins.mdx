...
Juan Atkins would continue to evolve the genre, creating the more abstract and experimental approach that would influence everything from minimal techno to <Term slug="idm">IDM</Term>.
