...
phreak.fm is built to feel like dialing into something. Dark, almost black, with a phosphor teal glow on top. Monospace nearly everywhere, the way a terminal sees the world, with a serif face brought in only for the long reads so the articles breathe like a page in a magazine.

There are faint scan lines over the whole thing, like a CRT that has been left on too long. A cursor blinks in the masthead. A status bar runs across the top, and a message of the day greets you the way a BBS used to when you logged in at 2am. On the front page a thin rain of characters falls in the background, signal in the static.

This is intentional, and it is not nostalgia for its own sake. It is the closest I could get to the feeling of the rooms this site is about: a phosphor screen at night, a modem handshake, a system that hums and waits for you to type the next thing. It runs on code and servers and fiber, but it is dressed like the terminal you wish you still had.
